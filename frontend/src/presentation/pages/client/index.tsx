          ...
          <table className='w-full table-auto border-separate text-white'>
            ...
            <tbody className='text-sm'>
              <tr className='text-center odd:bg-white/[0.25] even:bg-white/[0.12]'>
                <td className='rounded-l-lg leading-7'>Renato Mendes</td>
                <td>068.162.779-45</td>
                <td className='hidden md:table-cell'>mendeslrenato@gmail.com</td>
                <td className='hidden lg:table-cell text-[12px]'>Rua Josemar Guilherme, 176 - Biguaçu</td>
                <td className='hidden lg:table-cell'>(48) 999 601 309</td>
